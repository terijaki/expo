...
internal fun buildSnapshot(
  ...
  return NetworkRequest(
    ...
    // Gated on the absence of an error status so a late cancel cannot mask a 4xx or 5xx the
    // server already returned: `canceled` suppresses `error.type` downstream.
